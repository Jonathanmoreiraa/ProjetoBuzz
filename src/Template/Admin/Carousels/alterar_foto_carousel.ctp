<div class="d-flex">
    <div class="mr-auto p-2">
        <h2 class="display-4 titulo">Editar Foto do Carousel</h2>
    </div>
...
<div class="form-row">
    ...
    <div class="form-group col-md-6">
        ...
        ?>
        <img src='<?= $image_antiga ?>' alt='<?= $carousel->name?>' id="preview-img" class='img-thumbnail' style="width: 280px; height: 180px;">
    </div>
</div>
<p>
