...
//mudando a rota para sempre ir direto para o admin.
    $routes->connect('/', ['controller' => 'Home', 'action' => 'index']); //alterando para ir direto na tela home
    $routes->connect('/pages/*', ['controller' => 'Home', 'action' => 'index']);
    $routes->fallbacks(DashedRoute::class);
});

/**Tirar a view do endereço do link */
