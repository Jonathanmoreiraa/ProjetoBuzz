 ...
 * @method \App\Model\Entity\ArticlesCategory|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\ArticlesCategory saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
